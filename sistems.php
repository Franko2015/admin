    ...
    <div class="container">
        <div class="card p-2">
            <div class="card-title text-center">
                <h3>DATOS DE MIS SISTEMAS</h3>
            </div>
            <div class="card-body">
                <a class="btn btn-outline-success" href="controller/sistemas/add.php">Agregar nuevo sistema</a>
                    ...
                    <tbody>
                        ...
                        while ($mostrar = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><?php echo $mostrar['dns'] ?></td>
                                <td><?php echo $mostrar['hosting'] ?></td>
                                <td><?php echo $mostrar['costoTotal'] ?></td>
                                <td><a class="btn btn-dark" href="controller/sistemas/edit.php?id=<?php echo $mostrar['id']; ?>">Editar</a>
                                    <a class="btn btn-danger" href="model/sistemas/delete.php?id=<?php echo $mostrar['id']; ?>">Eliminar</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
