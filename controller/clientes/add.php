    ...
    <div class="container">
        <div class="card m-3 p-2">
            <div class="card-title text-center">
                <h3>FORMULARIO NUEVO CLIENTE</h3>
            </div>
            <form action="../../model/clientes/create.php" method="post">
                <div class="card-body">
                    <div class="row m-3">
                        <div class="input-group col">
                            <label for="rut" class="input-group-text">Rut: &nbsp;</label>
                            <input type="text" class="form-control" required id="rut" name="rut" />
