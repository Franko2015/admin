    ...
    <div class="container">
        <div class="card m-3 p-2">
            <div class="card-title text-center">
                <h3>FORMULARIO EDICIÓN DE CLIENTE: <?php echo $rut = $_GET['rut'] ?></h3>
            </div>
            <?php include("../../model/conexion.php");

            $sql = "SELECT * from tblCliente WHERE rut = '$rut'";
            $result = mysqli_query($con, $sql);

            while ($mostrar = mysqli_fetch_assoc($result)) { ?>

                <form action="../../model/clientes/edit.php" method="post">
                    <div class="card-body">
                        <div class="row m-3">
                        ...
                        <div class="row m-3">
                            <div class="input-group col">
                                <label for="dir" class="input-group-text">Dirección: &nbsp;</label>
                                <input type="text" class="form-control" required id="dir" name="dir" value="<?php echo $mostrar['direccion'] ?>"/>

                                <label for="fono" class="input-group-text">Teléfono: &nbsp;</label>
                                <input type="text" class="form-control" required id="fono" name="fono" value="<?php echo $mostrar['telefono'] ?>"/>
