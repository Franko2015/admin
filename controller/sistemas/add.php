    ...
    <div class="container">
        <div class="card m-3 p-2">
            <div class="card-title text-center">
                <h3>FORMULARIO NUEVO SISTEMA</h3>
            </div>
            <form action="../../model/sistemas/create.php" method="post">
                <div class="card-body">
                    <div class="row m-3">
                        <div class="input-group col">
                            ...
                            <input type="number" class="form-control" required id="costo" name="costo" />
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="input-group col">
                            <label for="DNS" class="input-group-text">DNS: &nbsp;</label>
                            <input type="text" class="form-control" required id="DNS" name="DNS" />

                            <label for="HOSTING" class="input-group-text">HOSTING: &nbsp;</label>
                            <input type="text" class="form-control" required id="HOSTING" name="HOSTING" />
